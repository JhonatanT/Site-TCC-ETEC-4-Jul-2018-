    ...
    <body>
        ...
        x.classList.toggle("change");
            ...
            <div class="tudo">
                ...
                <h2>2009</h2>
                    <ul>
                    <li>Prova Amarela<button class="amarela"><a href="">Gabarito</a></button><button class="amarela"><a href="#">Prova</a></button></li>
                    <li>Prova Amarela<button class="amarela"><a href="">Gabarito</a></button><button class="amarela"><a href="#">Prova</a></button></li>
                    
                    <li>Prova Azul<button class="azul"><a href="#">Gabarito</a></button><button class="azul"><a href="">Prova</a></button></li>
                    <li>Prova Azul<button class="azul"><a href="#">Gabarito</a></button><button class="azul"><a href="">Prova</a></button></li>
                    
                    <li>Prova Rosa<button class="rosa"><a href="#">Gabarito</a></button><button class="rosa"><a href="">Prova</a></button></li>
                        <li>Prova Rosa<button class="rosa"><a href="#">Gabarito</a></button><button class="rosa"><a href="">Prova</a></button></li>
                    
                        <li>Prova Branca<button class="Branca"><a href="#">Gabarito</a></button><button><a href="">Prova</a></button></li>
                    
                        <li>Prova Cinza<button class="cinza"><a href="#">Gabarito</a></button><button class="cinza"><a href="">Prova</a></button></li>
                    </ul>
